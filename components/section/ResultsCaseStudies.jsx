    ...
    <section ref={containerRef} className="py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <CaseStudyCard
          ...
          images={[
            {
              src: "https://placehold.co/350x500/0d0d0d/FF5733?text=MAX+BEFORE",
              label: "BEFORE",
              border: "#FF5733",
            },
            {
              src: "https://placehold.co/350x500/0d0d0d/00FF80?text=MAX+AFTER",
              label: "AFTER",
        ...
        <CaseStudyCard
          ...
          images={[
            {
              src: "https://placehold.co/350x500/0d0d0d/FF5733?text=SARAH+BEFORE",
              label: "BEFORE",
              border: "#FF5733",
            },
            {
              src: "https://placehold.co/350x500/0d0d0d/00FF80?text=SARAH+AFTER",
              label: "AFTER",
              border: "lime-electric",
            },
          ]}
        ...
        <div className="text-center pt-16 border-t border-subtle final-cta-section">
          <h2 className="text-4xl font-bold text-white mb-4">
            Is Your Performance Next?
          </h2>
          <p className="text-xl text-gray-400 mb-8">
            We only accept applicants ready to commit to this level of detail.
            Begin your qualification process.
          </p>
          <Link
            href="/apply"
    ...
    <div className="grid lg:grid-cols-2 gap-10 case-study-card p-6 rounded-xl bg-elevated">
      ...
      <div className="order-2 lg:order-1 ">
        ...
        <div className="grid grid-cols-3 gap-4 text-center border-t border-b border-subtle py-4 mb-6">
          {metrics.map((m, idx) => (
            <div key={idx}>
              <p className="text-5xl font-black text-lime-electric">
                {m.value}
              </p>
        ...
        {images.map((img, idx) => (
          <div key={idx} className="relative">
            <img
              src={img.src}
              alt={`${title} ${img.label}`}
              className={`rounded-lg w-full h-auto object-cover border-2 ${
                img.border === "lime-electric"
                  ? "border-lime-electric/50"
                  : `border-[${img.border}]/50`
              }`}
            />
            <p
